  ...
  return (
    <section id="about" className="mx-auto max-w-3xl px-6 py-28">
      ...
      >
        ...
        nationale Supérieure d&apos;Informatique, Algiers, one of Algeria&apos;s
        leading computer science schools. Previously a project assistant
        manager for Club Scientifique de l&apos;ESI, coordinating projects
        alongside coursework.
      </motion.p>

      <div className="mt-12 grid grid-cols-1 gap-4 border-t border-[var(--color-line)] pt-8 sm:grid-cols-2">
        {FACTS.map((fact, i) => (
          <motion.div
            key={fact.label}
